...
class Link(models.Model):
    ...
    WEIGHT_ITEMS = [(n, n) for n in range(1, 6)]
    ...
    status = models.PositiveIntegerField(default=STATUS_NORMAL, choices=STATUS_ITEMS,
                                         verbose_name='状态')
    weight = models.PositiveIntegerField(default=1, choices=WEIGHT_ITEMS, verbose_name='权重', help_text='从高到低展示')
